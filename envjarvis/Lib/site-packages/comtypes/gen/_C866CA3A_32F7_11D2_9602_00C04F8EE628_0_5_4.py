...
__all__ = [
    'SpFileStream', 'SVP_5', 'DISPID_SpeechMMSysAudio',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRRecognizer',
    'SPEI_SR_AUDIO_LEVEL', 'SPLEXICONTYPE', 'SGRSTTTextBuffer',
    'DISPID_SRCERecognition', 'DISPID_SRStatus', 'DISPID_SVSpeak',
    'SAFTNonStandardFormat', 'DISPID_SASCurrentDevicePosition',
    'SDTReplacement', 'SPLO_DYNAMIC',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SGRSTWeight', 'SPINTERFERENCE_TOOSLOW',
    'SAFT44kHz8BitMono', 'SPADAPTATIONRELEVANCE',
    'SPINTERFERENCE_TOOQUIET', 'eLEXTYPE_RESERVED7',
    'ISpStreamFormatConverter', 'DISPID_SLPsCount', 'SpShortcut',
    'DISPID_SPARecoResult', 'DISPID_SVSCurrentStreamNumber',
    'Speech_Max_Word_Length', 'DISPID_SRGCmdLoadFromFile',
    'SpObjectTokenCategory', 'SPEI_TTS_PRIVATE',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVGetAudioOutputs', 'SPDKL_CurrentUser', 'SLTApp',
    'DISPID_SPPId', 'SPSMF_UPS', 'SpInprocRecognizer',
    'SPWAVEFORMATTYPE', 'SVP_7', 'SP_VISEME_20',
    'DISPID_SRCEEndStream', 'DISPID_SRSCurrentStreamPosition',
    'SVSFPersistXML', 'SpeechUserTraining', 'SPEI_MIN_TTS',
    'SpMMAudioIn', 'ISpObjectToken', 'SVSFVoiceMask', 'SVPAlert',
    'SPRST_INACTIVE_WITH_PURGE', 'SPPARTOFSPEECH',
    'DISPID_SpeechPhoneConverter', 'ISpRecoContext',
    'SRERecoOtherContext', 'eLEXTYPE_RESERVED8', 'SVSFParseSapi',
    '__MIDL_IWinTypes_0009', 'DISPID_SRGId', 'SPSHT_EMAIL',
    'SP_VISEME_14', 'SVF_None', 'SGSExclusive',
    'DISPID_SPRNumberOfElements', 'SPAUDIOBUFFERINFO',
    'SPCT_DICTATION', 'DISPID_SRGDictationUnload', 'SVEAllEvents',
    'DISPID_SpeechVoiceEvent', 'SAFTADPCM_8kHzMono',
    'SAFTADPCM_11kHzStereo', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRRTStreamTime', 'DISPID_SPELexicalForm',
    'SPINTERFERENCE_NOISE', 'ISpeechPhraseAlternate', 'SVSFParseSsml',
    'SpeechEngineProperties', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'UINT_PTR',
    'SpeechDiscardType', 'DISPID_SABIEventBias', 'SVSFIsFilename',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPIReplacements',
    'DISPID_SVSPhonemeId', 'DISPID_SVSLastBookmark',
    'DISPID_SGRSAddWordTransition', 'SPWORDTYPE',
    'DISPID_SRCEInterference', 'DISPID_SRGDictationSetState',
    'SAFT48kHz8BitStereo', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRCEHypothesis', 'SpeechAudioProperties', 'SVSFIsXML',
    'SGRSTTDictation', 'DISPID_SOTId', 'SpeechEmulationCompareFlags',
    'SPRECOGNIZERSTATUS', 'SAFTADPCM_44kHzMono',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRRAudio',
    'DISPID_SRCEBookmark', 'DISPID_SpeechLexiconPronunciation',
    'ISpeechGrammarRule', 'ISpVoice', 'ISpAudio', 'SASClosed',
    'SRSActive', 'DISPID_SVSVisemeId', 'SVP_12',
    'SWPKnownWordPronounceable', 'SpeechTokenKeyUI',
    'SRSActiveAlways', 'SVEWordBoundary', 'SASRun',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechRecognizer',
    'ISpObjectWithToken', 'SINoise', 'DISPID_SPEsItem',
    'SpeechRecognizerState', 'DISPID_SRCEPhraseStart',
    'SRTExtendableParse', 'DISPID_SGRSTType', 'DISPID_SVEWord',
    'ISpeechGrammarRules', 'SPEI_SR_PRIVATE',
    'DISPID_SRCRetainedAudio', 'SAFT22kHz8BitMono', 'SPPS_Unknown',
    'DISPID_SpeechVoice', 'SPPS_RESERVED2', 'SPVPRI_NORMAL',
    'ISpeechPhoneConverter', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRRTTickCount', 'ISpPhoneticAlphabetSelection',
    'SPSHT_OTHER', 'DISPID_SABufferNotifySize', 'SPRECOSTATE',
    'SpeechTokenKeyAttributes', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPIGetText', 'DISPID_SLPSymbolic', 'DISPID_SRProfile',
    'SDTProperty', 'SVP_18', 'SGSDisabled', 'DISPID_SASetState',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRGetRecognizers',
    'SpeechTokenContext', 'DISPID_SGRSTPropertyId',
    'DISPID_SGRSTransitions', 'SLODynamic',
    'DISPID_SVSLastBookmarkId', 'SPEI_MAX_TTS',
    'DISPID_SDKSetLongValue', 'DISPID_SRRPhraseInfo',
    'SSFMOpenForRead', 'ISpRecognizer3', 'SPEI_SR_BOOKMARK',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCVoicePurgeEvent',
    'SECFEmulateResult', 'SPRS_ACTIVE', 'DISPID_SRGCmdLoadFromMemory',
    'SPINTERFERENCE_TOOFAST', 'SPBO_AHEAD', 'DISPID_SGRName',
    'DISPID_SPRulesItem', 'SRESoundStart', 'DISPID_SVAlertBoundary',
    'SAFT32kHz8BitMono', 'SpeechAudioFormatType',
    'DISPID_SpeechPhraseElement', 'SVESentenceBoundary',
    'SpeechAudioVolume', 'ISpRecoContext2', 'SDKLCurrentConfig',
    'SAFT44kHz16BitMono', 'SpeechAudioFormatGUIDWave',
    'SAFT8kHz8BitMono', 'SAFT16kHz16BitStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechWordType',
    'DISPID_SPIEngineId', 'SpeechAudioState', 'SREHypothesis',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SOTCSetId', 'SDTAudio', 'SLTUser', 'SSTTTextBuffer',
    'SPAO_RETAIN_AUDIO', 'SP_VISEME_17',
    'DISPID_SpeechPhraseReplacements', 'ISpRecoCategory',
    'DISPID_SGRsAdd', 'SPEVENTENUM', 'SPEI_TTS_BOOKMARK',
    'SP_VISEME_5', 'DISPID_SPPParent', 'ISpeechRecoResultTimes',
    'DISPID_SMSSetData', 'WAVEFORMATEX', 'ISpeechObjectTokens',
    'DISPID_SVSInputSentencePosition', 'STSF_FlagCreate',
    'SpeechRecoContextState', 'ISequentialStream',
    'DISPID_SpeechRecoContextEvents', 'SpeechRegistryUserRoot',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SAFGetWaveFormatEx',
    'ISpXMLRecoResult', 'SASStop', 'SpeechVoiceEvents',
    'DISPID_SLWsItem', 'SECFIgnoreWidth', 'SAFT11kHz16BitMono',
    'SRAImport', 'SVPNormal', 'SPAS_CLOSED', 'SITooQuiet',
    'SPVPRI_ALERT', 'SAFTGSM610_44kHzMono', 'DISPID_SASNonBlockingIO',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechPhraseProperties',
    'ISpeechAudioBufferInfo', 'SGSEnabled', 'SpeechTokenShellFolder',
    'SP_VISEME_4', 'SpeechRetainedAudioOptions', 'STCLocalServer',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpNullPhoneConverter',
    'SpeechVoiceSpeakFlags', 'SPXRO_SML', 'ISpPhrase',
    'DISPID_SPRFirstElement', 'ISpRecognizer', 'SpSharedRecognizer',
    'SpeechLoadOption', 'SPVPRI_OVER', 'SPEVENTSOURCEINFO',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCESoundEnd',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVP_0',
    'ISpeechRecoContext', 'SAFTGSM610_11kHzMono', 'SpeechLexiconType',
    'SpLexicon', 'ISpeechPhraseRules', 'SVEVoiceChange',
    'SpeechGrammarTagDictation', 'DISPID_SABIMinNotification',
    'DISPID_SRCEAudioLevel', 'SVP_16', 'SPAR_Low',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFT24kHz16BitMono',
    'SpeechInterference', 'DISPID_SRSAudioStatus',
    'DISPID_SASFreeBufferSpace', 'SPEI_VISEME', 'SP_VISEME_10',
    'DISPID_SDKSetStringValue', 'ISpeechPhraseAlternates',
    'SPEI_INTERFERENCE', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SVEEnginePrivate', 'SVP_2', 'DISPID_SpeechObjectToken',
    'DISPID_SPPEngineConfidence', 'DISPID_SLWLangId',
    'SpeechPropertyResponseSpeed', 'SpeechCategoryAudioIn',
    'ISpeechPhraseReplacements', 'DISPID_SMSALineId', '_SPAUDIOSTATE',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRGetPropertyNumber',
    'SPAR_Unknown', 'SpeechCategoryRecognizers',
    'DISPID_SLAddPronunciation', 'SPFM_OPEN_READONLY',
    'DISPID_SWFEBitsPerSample', 'DISPID_SAFType', 'ISpLexicon',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRRTLength',
    'SDTPronunciation', 'SPSNotOverriden', 'STCAll',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRGIsPronounceable',
    'SDTDisplayText', 'SINoSignal', 'DISPID_SVIsUISupported',
    'DISPID_SpeechDataKey', 'SPLOADOPTIONS',
    'SpeechCategoryPhoneConverters', 'SPEI_RESERVED6',
    'SpInProcRecoContext', 'DISPID_SPRuleConfidence',
    'DISPID_SLWsCount', 'ISpeechVoice', 'SpeechAllElements',
    'SPPS_Modifier', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRGSetWordSequenceData', 'SGLexicalNoSpecialChars',
    'DISPID_SPRsItem', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_PRIVATE5', 'SVP_9', 'DISPID_SVWaitUntilDone',
    'SPFM_NUM_MODES', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpeechRecognizer', 'DISPID_SpeechMemoryStream', 'SPCT_COMMAND',
    'SRAONone', 'SPRECORESULTTIMES', 'SP_VISEME_13',
    'STCRemoteServer', 'SREAllEvents', 'DISPID_SWFESamplesPerSec',
    'eLEXTYPE_PRIVATE19', 'DISPID_SLPType',
    'DISPID_SASCurrentSeekPosition', 'SpPhraseInfoBuilder',
    'SP_VISEME_6', 'DISPID_SLWWord', 'SPGS_ENABLED',
    'eLEXTYPE_PRIVATE13', 'DISPID_SLGetGenerationChange',
    'SPSERIALIZEDRESULT', 'DISPID_SRCRequestedUIType',
    'ISpeechRecognizerStatus', 'SPDATAKEYLOCATION',
    'eLEXTYPE_PRIVATE1', 'SPEI_SOUND_START', 'SVSFDefault',
    'DISPID_SpeechObjectTokens', 'SpStream', 'SAFTADPCM_22kHzStereo',
    'SITooSlow', 'SSFMCreate', 'SpeechBookmarkOptions',
    'SpeechSpecialTransitionType', 'DISPID_SPAPhraseInfo',
    'eLEXTYPE_PRIVATE7', 'DISPID_SFSClose', 'SP_VISEME_8',
    'SPFILEMODE', 'SpeechTokenKeyFiles', 'DISPID_SRCCreateGrammar',
    'SRATopLevel', 'SECHighConfidence', 'SVP_19',
    'SpeechEngineConfidence', 'eLEXTYPE_APP', 'eLEXTYPE_PRIVATE6',
    'SAFT16kHz8BitStereo', 'ISpeechBaseStream',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPIRule', 'DISPID_SPEAudioSizeTime', 'ISpNotifySink',
    'DISPID_SVESentenceBoundary', 'ISpeechObjectTokenCategory',
    'Speech_StreamPos_RealTime', 'SpeechWordPronounceable',
    'DISPID_SPRuleId', 'DISPID_SpeechGrammarRuleStateTransition',
    'ISpeechAudio', 'DISPID_SGRId', 'SPBO_PAUSE', 'SPPS_Function',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRGRules', 'SPPS_RESERVED1',
    'DISPID_SRGDictationLoad', 'SAFT8kHz8BitStereo',
    'SSFMCreateForWrite', 'SPSHORTCUTTYPE', 'SECFIgnoreCase',
    'DISPID_SAFGuid', 'SSTTDictation', 'IInternetSecurityMgrSite',
    'SPCT_SUB_DICTATION', 'SLOStatic', 'SPSVerb', 'IEnumString',
    'Speech_Max_Pron_Length', 'DISPID_SpeechPhraseBuilder',
    'SGPronounciation', 'DISPID_SRRRecoContext',
    'DISPID_SpeechPhraseAlternates', 'ISpResourceManager',
    'SVEAudioLevel', 'DISPID_SOTRemoveStorageFileName',
    'ISpeechPhraseElements', 'SAFT12kHz8BitStereo', 'SP_VISEME_9',
    'SPEI_UNDEFINED', 'DISPID_SDKOpenKey',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SOTCGetDataKey',
    'DISPID_SVGetVoices', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRSNumberOfActiveRules', 'eLEXTYPE_PRIVATE14',
    'SPINTERFERENCE', 'DISPID_SVEStreamStart', 'ISpMMSysAudio',
    'ISpProperties', 'SVP_1', 'SAFTCCITT_ALaw_44kHzMono',
    'SPGRAMMARWORDTYPE', 'SPSHT_Unknown', 'DISPID_SVSpeakStream',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPEDisplayAttributes',
    'ISpeechPhraseProperty', 'eLEXTYPE_PRIVATE17',
    'DISPID_SMSAMMHandle', 'ISpeechResourceLoader',
    'DISPID_SRSSupportedLanguages', 'SPWORDPRONUNCIATIONLIST',
    'DISPIDSPRG', 'DISPID_SVDisplayUI', 'DISPID_SOTsCount',
    'eLEXTYPE_MORPHOLOGY', 'SPAS_RUN', 'SPEI_RESERVED1',
    'SP_VISEME_7', 'DISPID_SRRSetTextFeedback', 'SPPHRASEREPLACEMENT',
    'SP_VISEME_1', 'DISPID_SRGState', 'SPPS_RESERVED3',
    'SPXRO_Alternates_SML', 'SpeechPropertyAdaptationOn',
    'SRSInactiveWithPurge', 'DISPID_SOTDataKey', 'DISPID_SGRSRule',
    'SpeechCategoryRecoProfiles', 'SVSFUnusedFlags',
    'DISPID_SGRSTRule', 'SAFTCCITT_uLaw_22kHzMono',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpeechMMSysAudio',
    'DISPID_SRCESoundStart', 'SPGS_DISABLED',
    'SpeechAudioFormatGUIDText', 'DISPID_SBSSeek',
    'DISPID_SPPs_NewEnum', 'SPEI_RESERVED3', 'SECFNoSpecialChars',
    'DISPID_SPRuleChildren', 'SPAUDIOOPTIONS', 'SP_VISEME_2',
    'SRESoundEnd', 'ISpeechLexiconWords', 'DISPID_SRAudioInput',
    'SPSEMANTICFORMAT', 'SVF_Stressed', 'DISPID_SGRSTPropertyName',
    'DISPID_SPIRetainedSizeBytes', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechPropertyResourceUsage', 'DISPID_SLPLangId',
    'DISPID_SOTIsUISupported', 'DISPID_SRRAlternates', 'SP_VISEME_18',
    'SPLO_STATIC', 'DISPID_SPCPhoneToId',
    'SpeechRecoProfileProperties', 'SPAR_High',
    'SPEI_END_INPUT_STREAM', 'DISPID_SAVolume',
    'DISPID_SpeechPhraseInfo', 'SVEPhoneme', 'ISpEventSink',
    'SRERequestUI', 'SDTRule',
    'SpeechPropertyNormalConfidenceThreshold',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechGrammarRuleState',
    'SVPOver', 'SFTSREngine', 'DISPID_SPILanguageId',
    'SPEI_VOICE_CHANGE', 'DISPID_SGRsCommit', 'SPEI_RESERVED2',
    'ISpNotifySource', 'SPEI_ADAPTATION', 'SP_VISEME_12',
    'SpeechGrammarState', 'SAFTExtendedAudioFormat', 'SBONone',
    'DISPID_SRCEventInterests', 'DISPID_SPIAudioStreamPosition',
    'SDTLexicalForm', 'SPINTERFERENCE_NOSIGNAL', 'ISpeechPhraseInfo',
    'IStream', 'ISpShortcut', 'SAFTCCITT_ALaw_11kHzMono',
    'SVSFNLPMask', 'DISPID_SGRAddResource', 'DISPID_SPRulesCount',
    'DISPID_SLPPhoneIds', 'SECLowConfidence',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SGRSTsItem', 'SECFDefault',
    'SpeechDataKeyLocation', 'SPTEXTSELECTIONINFO',
    'ISpNotifyTranslator', 'SVP_17', 'DISPID_SPRuleFirstElement',
    'SPEI_SENTENCE_BOUNDARY', 'SFTInput', 'SPCATEGORYTYPE',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPISaveToMemory',
    'DISPID_SPRules_NewEnum', 'eLEXTYPE_RESERVED4', 'SPSFunction',
    'DISPID_SPIAudioSizeTime', 'SINone', 'DISPID_SVPriority',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASState', 'SASPause', 'DISPID_SWFEFormatTag',
    'SPPS_NotOverriden', 'SAFTDefault', 'SpVoice',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechRecoResultDispatch',
    'SPSTREAMFORMATTYPE', 'DISPID_SDKGetStringValue',
    'DISPID_SGRsDynamic', 'SVP_15', 'DISPID_SVEPhoneme',
    'DISPID_SpeechBaseStream', 'DISPID_SPRs_NewEnum',
    'ISpeechTextSelectionInformation', 'SRAInterpreter', 'SGRSTTRule',
    'SRCS_Disabled', 'SpSharedRecoContext', 'DISPID_SVStatus',
    'SPEI_MIN_SR', 'SP_VISEME_15', 'DISPID_SpeechLexiconProns',
    'SpeechRunState', 'DISPID_SMSADeviceId', 'SPDKL_LocalMachine',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SOTCId',
    'DISPID_SPRuleNumberOfElements',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPIAudioSizeBytes',
    'SPRULESTATE', 'ISpDataKey', 'SSFMOpenReadWrite', 'SRSEDone',
    'DISPID_SRGCmdSetRuleState', 'eLEXTYPE_PRIVATE3',
    'SpeechCategoryVoices', 'STSF_AppData', 'ISpeechRecoGrammar',
    'SPPS_RESERVED4', 'SREInterference', 'SAFT11kHz8BitMono',
    'SpPhoneConverter', 'DISPID_SDKEnumValues', 'SVP_21',
    'DISPID_SAStatus', 'SpWaveFormatEx', 'DISPID_SGRSTsCount',
    'DISPID_SAEventHandle', 'DISPID_SGRSTText',
    '_ISpeechRecoContextEvents', 'DISPID_SPPConfidence',
    'DISPID_SRRAudioFormat', 'DISPID_SVSLastStreamNumberQueued',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SOTCDefault',
    'SAFT16kHz8BitMono', 'DISPID_SRCEEnginePrivate', 'SVP_4',
    'ISpStreamFormat', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPPsItem', 'LONG_PTR', 'DISPID_SOTGetDescription',
    'ISpeechPhraseRule', 'SpeechTokenIdUserLexicon', 'SGDSActive',
    'DISPID_SpeechAudioFormat', 'DISPID_SpeechRecoResult2',
    'DISPID_SDKEnumKeys', '_ISpeechVoiceEvents', 'SREStreamStart',
    'DISPID_SPERequiredConfidence', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRIsShared', 'DISPID_SpeechLexiconWords',
    'SAFT12kHz16BitMono', 'DISPID_SRSClsidEngine', 'SPSUnknown',
    'DISPID_SPAStartElementInResult', 'DISPID_SpeechGrammarRule',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRGRecoContext',
    'ISpeechGrammarRuleStateTransition', 'SDKLDefaultLocation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechLexicon', 'SVP_14',
    ...
    'SP_VISEME_21', 'SpTextSelectionInformation',
    'DISPID_SOTCreateInstance', 'SPINTERFERENCE_NONE',
    'DISPID_SOTDisplayUI', 'SpeechGrammarWordType', 'SREBookmark',
    'SPBINARYGRAMMAR', 'DISPID_SPEEngineConfidence',
    'SpeechRuleAttributes', 'DISPID_SPACommit',
    'DISPID_SABIBufferSize', 'SpeechStreamSeekPositionType', 'SPSLMA',
    'SPEI_RECO_OTHER_CONTEXT', 'SPBO_TIME_UNITS',
    'ISpeechXMLRecoResult', 'ISpRecoGrammar2', 'SAFTNoAssignedFormat',
    'SAFT44kHz8BitStereo', 'DISPID_SOTMatchesAttributes',
    'SVSFParseAutodetect', 'ISpeechFileStream',
    'ISpPhoneticAlphabetConverter', 'SPVPRIORITY', 'tagSTATSTG',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRCPause', 'DISPID_SMSGetData', 'eWORDTYPE_ADDED',
    ...
    'SPRECOCONTEXTSTATUS', 'SPBO_NONE', 'SpeechRecoEvents',
    'SpeechVisemeType', 'SRTStandard', 'SpeechRecognitionType',
    'SPAS_PAUSE', 'SVEStartInputStream', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPIGrammarId', 'IEnumSpObjectTokens', 'SREStreamEnd',
    'DISPID_SpeechAudio', 'SpMemoryStream', 'DISPID_SLPsItem',
    'DISPID_SPIProperties', 'SPRS_INACTIVE', 'SPRULE', 'SPRST_ACTIVE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT48kHz16BitStereo',
    'SpeechPropertyComplexResponseSpeed', 'SAFT11kHz8BitStereo',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SLWs_NewEnum',
    'SAFT48kHz16BitMono', 'eLEXTYPE_PRIVATE12', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRRSpeakAudio', 'SDA_Consume_Leading_Spaces',
    'ISpPhoneConverter', 'ISpeechPhraseInfoBuilder',
    'eLEXTYPE_RESERVED9', 'SPPS_Noncontent', 'SpeechCategoryAudioOut',
    'ISpRecoResult', 'SpeechVisemeFeature', 'DISPID_SVVolume',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechRecoResult',
    'SVEBookmark', 'SAFT48kHz8BitMono', 'ISpeechGrammarRuleState',
    'SpeechRuleState', 'SPFM_OPEN_READWRITE',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SDKDeleteValue',
    'DISPID_SADefaultFormat', 'DISPID_SVEventInterests',
    'DISPID_SPPValue', 'SpeechPartOfSpeech', 'ISpeechVoiceStatus',
    'DISPID_SRSetPropertyNumber', 'SREAudioLevel',
    'DISPID_SOTGetStorageFileName', 'ISpeechLexiconPronunciation',
    'DISPID_SDKSetBinaryValue', 'SECFIgnoreKanaType',
    'DISPID_SPRuleParent', 'DISPID_SPCLangId', 'SAFT24kHz16BitStereo',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechPhraseReplacement',
    'STSF_CommonAppData', 'SGRSTTWord', 'ISpeechMemoryStream',
    'SpResourceManager', 'ISpRecognizer2', 'DISPID_SPRuleName',
    'ISpEventSource', 'SPAR_Medium', 'DISPID_SPRDisplayAttributes',
    'DISPID_SLGenerationId', 'SWTAdded', 'DISPID_SRGCommit',
    'SREPropertyStringChange', 'DISPID_SPAsCount', 'SRTAutopause',
    'DISPID_SRRTimes', 'DISPID_SVGetAudioInputs',
    'SpeechStreamFileMode', 'SPCS_ENABLED', 'SPEI_RECOGNITION',
    'DISPID_SPEs_NewEnum', 'SP_VISEME_11', 'SPWT_PRONUNCIATION',
    'SPFM_CREATE_ALWAYS', 'SPEI_MAX_SR', 'SP_VISEME_19',
    'DISPID_SRCreateRecoContext', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPPChildren',
    'SGDSActiveUserDelimited', 'SpCompressedLexicon',
    'DISPID_SRRGetXMLResult', 'SPWF_SRENGINE',
    'SDA_No_Trailing_Space', 'SVSFParseMask', 'DISPID_SRCResume',
    'ISpeechCustomStream', 'SPPS_Noun', 'SRSInactive',
    'Speech_StreamPos_Asap', 'DISPID_SPPsCount',
    'DISPID_SGRSTs_NewEnum', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_3',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SWPUnknownWordUnpronounceable', 'SVSFlagsAsync',
    'SAFT24kHz8BitMono', 'SPSSuppressWord', 'DISPID_SLWType',
    'DISPID_SGRClear', 'SpNotifyTranslator', 'DISPID_SGRsFindRule',
    'SpeechGrammarTagWildcard', 'SPEI_REQUEST_UI',
    'DISPID_SLGetWords', 'SDKLCurrentUser', 'DISPID_SBSWrite',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVEVoiceChange',
    'DISPID_SGRAttributes', 'SPWORD', 'SDA_One_Trailing_Space',
    'SpeechCategoryAppLexicons', 'DISPID_SGRsItem', 'SPVOICESTATUS',
    'DISPID_SPAs_NewEnum', 'DISPID_SRCERequestUI',
    'ISpeechAudioStatus', 'SAFTGSM610_8kHzMono', 'DISPID_SOTsItem',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRSetPropertyString',
    'SPDKL_DefaultLocation', 'DISPID_SBSFormat', 'SVP_10',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechTokenValueCLSID',
    'SPPHRASE', 'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRSTPropertyValue', 'SpMMAudioEnum',
    'SSSPTRelativeToStart', 'SPAO_NONE', 'SPCT_SLEEP',
    'STCInprocHandler', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCEStartStream', 'SPPS_SuppressWord',
    'SAFT8kHz16BitStereo', 'SAFT32kHz16BitMono', 'SPSHORTCUTPAIR',
    'DISPID_SPRsCount', 'SPCT_SUB_COMMAND', 'SPPHRASERULE',
    'DISPID_SPAsItem', 'ISpStream', 'SVF_Emphasis', 'SREPhraseStart',
    'SREPropertyNumChange', 'SPWORDPRONOUNCEABLE',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPAS_STOP', 'SVP_20', 'DISPID_SRGReset', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SOTRemove', 'SpeechGrammarRuleStateTransitionType',
    'SRTEmulated', 'SPFM_CREATE', 'SAFT12kHz8BitMono',
    'eWORDTYPE_DELETED', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRCVoice', 'SAFT22kHz16BitMono',
    'DISPID_SRCERecognizerStateChange', 'SpeechFormatType',
    'ISpObjectTokenCategory', 'DISPID_SLPs_NewEnum',
    'ISpeechObjectToken', 'SP_VISEME_16', 'SpeechMicTraining',
    'SpeechVoiceCategoryTTSRate', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SGRAddState', 'SPEVENT', 'DISPID_SpeechLexicon',
    'DISPID_SABufferInfo', 'SVP_8', 'DISPID_SVSInputSentenceLength',
    'SpMMAudioOut', 'DISPID_SPERetainedStreamOffset',
    'SPSEMANTICERRORINFO', 'SP_VISEME_0', 'DISPID_SRCState',
    'DISPID_SOTs_NewEnum', 'DISPID_SVAudioOutput',
    'eLEXTYPE_PRIVATE20', 'SPEI_PHRASE_START',
    'DISPID_SpeechFileStream', 'DISPIDSPTSI', 'SPXMLRESULTOPTIONS',
    'SPGS_EXCLUSIVE', 'DISPID_SRIsUISupported',
    'DISPID_SDKGetlongValue', 'SSSPTRelativeToCurrentPosition',
    ...
    'DISPID_SFSOpen', 'SRAExport', 'SREPrivate',
    'DISPID_SRCEAdaptation', 'SPCS_DISABLED', 'DISPID_SOTSetId',
    'DISPID_SVSRunningState', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCEPropertyStringChange', 'SpCustomStream',
    'eLEXTYPE_PRIVATE8', 'ISpeechLexiconWord',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT11kHz16BitStereo',
    'SpAudioFormat', 'DISPID_SRCRecognizer', 'SITooFast',
    'SVSFIsNotXML', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRGetFormat', 'SPEI_START_INPUT_STREAM',
    'DISPID_SDKCreateKey', 'SPPS_Interjection', 'SPSModifier',
    'SPSInterjection', 'SREAdaptation',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechAudioStatus',
    'SPAUDIOSTATUS', 'SGDSActiveWithAutoPause',
    'DISPIDSPTSI_SelectionOffset', 'SPINTERFERENCE_LATENCY_WARNING',
    'SWTDeleted', 'SRAORetainAudio', 'DISPID_SPPName',
    'DISPID_SRAudioInputStream', 'SRADefaultToActive', 'SGDisplay',
    'SAFTADPCM_11kHzMono', 'DISPID_SVGetProfiles',
    'DISPID_SPCIdToPhone', 'SPPS_LMA', 'SPSHT_NotOverriden',
    'DISPID_SWFEBlockAlign', 'SDKLLocalMachine', 'SPWT_DISPLAY',
    ...
    'DISPID_SRGCmdLoadFromResource', 'SPRST_INACTIVE', 'SVP_6',
    ...
    'SPBOOKMARKOPTIONS', 'SRTReSent', 'SAFT16kHz16BitMono',
    'SVEPrivate', 'DISPID_SCSBaseStream',
    'DISPID_SPEAudioStreamOffset', 'SVEViseme',
    'DISPID_SpeechLexiconWord', 'SPPHRASEPROPERTY',
    'eLEXTYPE_RESERVED10', 'SpStreamFormatConverter', 'DISPID_SVRate',
    'DISPID_SVEViseme', 'DISPID_SpeechXMLRecoResult', 'SGLexical',
    'DISPID_SPIStartTime', 'ISpRecoGrammar', 'SREFalseRecognition',
    'SpeechDictationTopicSpelling', 'DISPID_SRCBookmark',
    'DISPID_SpeechRecoContext', 'DISPID_SPEPronunciation', 'SVP_11',
    'DISPID_SVEBookmark', 'DISPID_SGRs_NewEnum',
    'DISPID_SWFEExtraData', 'DISPID_SVEStreamEnd', 'SPEI_RESERVED5',
    'DISPID_SDKDeleteKey', 'DISPID_SpeechGrammarRules', 'SP_VISEME_3',
    'DISPIDSPTSI_SelectionLength', 'SWPUnknownWordPronounceable',
    'SVSFNLPSpeakPunc', 'SAFT22kHz16BitStereo', 'SPSERIALIZEDPHRASE',
    'ISpeechPhraseElement', 'SpeechAddRemoveWord', 'ISpPhraseAlt',
    'eLEXTYPE_PRIVATE2', 'SRADynamic', 'SBOPause',
    'DISPID_SVSInputWordLength', 'DISPID_SPEDisplayText',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPRST_ACTIVE_ALWAYS',
    'SAFT8kHz16BitMono', 'ISpeechAudioFormat', 'ISpSerializeState',
    'SpObjectToken', 'DISPID_SVResume', 'DISPID_SLWPronunciations',
    'SPPS_Verb', 'SPWF_INPUT', 'SVP_13', 'SRTSMLTimeout',
    'DISPID_SAFSetWaveFormatEx', 'SDA_Two_Trailing_Spaces',
    'SPPROPERTYINFO', 'DISPID_SBSRead', 'SDTAlternates',
    'SpeechVoicePriority', 'SRSEIsSpeaking', 'SPDKL_CurrentConfig',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechPhraseRules', 'SAFTCCITT_uLaw_8kHzMono',
    'STCInprocServer', 'SRARoot', 'SpeechVoiceSkipTypeSentence',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTCCITT_uLaw_44kHzMono',
    'SAFTADPCM_44kHzStereo', 'SGRSTTEpsilon', 'SAFTADPCM_22kHzMono',
    'eLEXTYPE_RESERVED6', 'SDTAll', 'SPEI_END_SR_STREAM',
    'DISPID_SVPause', 'eLEXTYPE_PRIVATE4', 'DISPID_SPPFirstElement',
    'DISPID_SVSpeakCompleteEvent', 'SAFT22kHz8BitStereo',
    'Speech_Default_Weight', 'SPWORDPRONUNCIATION',
    'SAFTADPCM_8kHzStereo', 'SRCS_Enabled', 'DISPID_SRRSaveToMemory',
    'ISpeechGrammarRuleStateTransitions', 'SpeechDisplayAttributes',
    'ISpeechDataKey', 'ISpeechWaveFormatEx', 'SAFTText',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPVISEMES', 'eLEXTYPE_USER',
    'DISPID_SpeechPhraseElements', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPGRAMMARSTATE', 'IInternetSecurityManager', 'DISPID_SVSkip',
    'SAFT44kHz16BitStereo', 'DISPID_SOTGetAttribute', 'SPEI_PHONEME',
    'SRERecognition', 'DISPID_SPRText', '_RemotableHandle',
    'SITooLoud', 'SAFTGSM610_22kHzMono', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPAUDIOSTATE', 'SPWORDLIST', 'ISpeechPhraseReplacement',
    'DISPID_SGRInitialState', 'SAFTCCITT_ALaw_8kHzMono',
    'STSF_LocalAppData', 'SAFT12kHz16BitStereo', 'SPPHRASEELEMENT',
    'SAFT24kHz8BitStereo', 'SPRS_ACTIVE_USER_DELIMITED',
    ...
    'eLEXTYPE_PRIVATE11', 'DISPID_SVVoice', 'SPSNoun',
    'SGRSTTWildcard', 'DISPID_SGRsCount', 'SAFT32kHz8BitStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechRecoResult',
    'DISPID_SPRuleEngineConfidence', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPIElements', 'DISPID_SPEsCount',
    'DISPID_SRCEPropertyNumberChange', 'SECNormalConfidence',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPEActualConfidence',
    'SGDSInactive', 'DISPID_SRState'
]

_check_version('1.2.0', 1700238844.717088)
